...
export function WhyWexelo() {
  return (
    <section className="pt-12 md:pt-16 lg:py-24 pb-14 md:pb-16 bg-white">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 lg:gap-20 items-start w-full">
          {/* Left: Statement */}
          <ScrollReveal>
            <div className="lg:sticky lg:top-32 w-full">
              <p className="text-sm font-semibold tracking-widest uppercase text-electric mb-3 md:mb-4">Why Choose Us</p>
              <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-primary-text mb-6">
                Why WEXELO
              </h2>
              <p className="text-[1.05rem] min-[390px]:text-lg md:text-xl lg:text-2xl text-secondary-text leading-relaxed mb-7 md:mb-8">
          ...
          {/* Right: Benefit Cards */}
          <StaggerChildren className="space-y-3 min-[390px]:space-y-4 w-full">
              ...
              return (
                <StaggerItem key={benefit.title}>
                  <motion.div
                    ...
                    className="group flex gap-4 md:gap-5 p-4 min-[390px]:p-5 rounded-xl border border-border hover:border-electric/30 bg-white hover:bg-light-bg transition-all duration-300 w-full"
                  >
